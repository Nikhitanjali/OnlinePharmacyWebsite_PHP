				...
				if (isset($_SESSION['msg'])) {
					...
					$ID1 = $_SESSION['id'];	
						...
						if($count1 <= 0){
							...
							//echo "<center><a href = \"payment.php\"><button type=\"submit\" name=\"submit\" class=\"btn btn-success btn-round\"><i class=\"now-ui-icons shopping_delivery-fast\"></i> Save Address and Continue</button></a></center>";
						}
						else{
				?>
